          ...
          participantsHTML = `<ul class=\"participants-list\">${details.participants
            .map(
              (participant) =>
                ...
                + `<span class=\"delete-participant\" title=\"Remove\" data-activity=\"${name}\" data-email=\"${participant}\">&#10060;</span>`
                + `</li>`
            )
            .join("")}</ul>`;
        } else {
          participantsHTML = "<p class=\"no-participants\">No participants signed up yet.</p>";
        }
